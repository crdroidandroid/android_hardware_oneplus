...
public class DeviceExtras extends PreferenceFragment
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        if (isFeatureSupported(context, R.bool.config_deviceSupportsTPEdgeLimit)) {
            ...
            pm.setComponentEnabledSetting (new ComponentName(context, TPEdgeLimitModeTileService.class), PackageManager.COMPONENT_ENABLED_STATE_ENABLED, PackageManager.DONT_KILL_APP);
        }
        else {
