...
public class ActionUtils {
    ...
    private static Intent getDeviceExtrasIntent(Context context) {
        Intent intent = new Intent();
        ComponentName cn=new ComponentName("org.lineageos.oneplus.DeviceExtras",
                "org.lineageos.oneplus.DeviceExtras.DeviceExtrasActivity");
        intent.setComponent(cn);
        return intent;
    }
    ...
    public static void triggerAction(Context context, int action) {
        ...
        if (km.isKeyguardLocked()) {
            intent = new Intent();
            intent.setClassName("org.lineageos.oneplus.DeviceExtras", "org.lineageos.oneplus.DeviceExtras.touch.ScreenOffLaunchGestureActivity");
